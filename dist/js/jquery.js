...
;(function (window, undefined) {
  ...
  ;(function (window, undefined) {
    var i,
      ...
      pseudos =
        ':(' + characterEncoding + ')(?:\\((([\'"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|' + attributes.replace(3, 8) + ')*)|.*)\\)|)',
    ...
    mouseHooks: {
      ...
      filter: function (event, original) {
        ...
        if (event.pageX == null && original.clientX != null) {
          ...
          event.pageY =
            original.clientY + ((doc && doc.scrollTop) || (body && body.scrollTop) || 0) - ((doc && doc.clientTop) || (body && body.clientTop) || 0)
        }
  ...
  function css_defaultDisplay(nodeName) {
    ...
    if (!display) {
      ...
      if (display === 'none' || !display) {
        ...
        iframe = (iframe || jQuery("<iframe frameborder='0' width='0' height='0'/>").css('cssText', 'display:block !important')).appendTo(
          doc.documentElement
        )
